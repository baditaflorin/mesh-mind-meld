...
**Live → https://baditaflorin.github.io/mesh-mind-meld/**

**Source → https://github.com/baditaflorin/mesh-mind-meld**
...
git clone https://github.com/baditaflorin/mesh-mind-meld
cd mesh-mind-meld
npm install
npm run dev
```
...
- `mesh-mind-meld:signalingUrl`
- `mesh-mind-meld:turnTokenUrl`
- `mesh-mind-meld:iceServers`
- `mesh-mind-meld:room`
